(ns marketentry.store
  "SSoT for the IDN market-entry compliance actor, behind a `Store`
...
(defn demo-data
  ...
  []
  {:engagements
   {"eng-1" {:id "eng-1" :operator "Kita Systems ID" :portal "SPSE"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-id-entity? true :has-id-entity? true
             :requires-nib? true :nib-verified? true
             :drafted? false :submitted? false
             :jurisdiction "IDN" :status :intake}
    "eng-2" {:id "eng-2" :operator "Atlantis LLC" :portal "SPSE"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-id-entity? true :has-id-entity? true
             :requires-nib? true :nib-verified? true
    ...
    "eng-3" {:id "eng-3" :operator "Minami Systems" :portal "SPSE"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             ...
             :drafted? false :submitted? false
             :jurisdiction "IDN" :status :intake}
    "eng-4" {:id "eng-4" :operator "Higashi Export" :portal "SPSE"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-id-entity? true :has-id-entity? false
             :requires-nib? true :nib-verified? true
             :drafted? false :submitted? false
             :jurisdiction "IDN" :status :intake}
    "eng-5" {:id "eng-5" :operator "Nishi Logistics" :portal "SPSE"
             :base-fee 500000 :monthly-rate 30000 :monitoring-months 12
             :claimed-fee 860000.0
             :requires-id-entity? true :has-id-entity? true
             :requires-nib? true :nib-verified? false
             :drafted? false :submitted? false
             :jurisdiction "IDN" :status :intake}
    "eng-6" {:id "eng-6" :operator "Chuo Civic Tech" :portal "SPSE"
...
(defn- engagement->tx [{:keys [id operator portal base-fee monthly-rate monitoring-months claimed-fee
                               requires-id-entity? has-id-entity?
                               requires-nib? nib-verified?
                               drafted? submitted?
  ...
  (cond-> {:engagement/id id}
    ...
    (some? requires-id-entity?)  (assoc :engagement/requires-id-entity? requires-id-entity?)
    (some? has-id-entity?)       (assoc :engagement/has-id-entity? has-id-entity?)
    (some? requires-nib?)    (assoc :engagement/requires-nib? requires-nib?)
    (some? nib-verified?)    (assoc :engagement/nib-verified? nib-verified?)
...
(def ^:private engagement-pull
  [:engagement/id :engagement/operator :engagement/portal :engagement/base-fee :engagement/monthly-rate
   ...
   :engagement/requires-id-entity? :engagement/has-id-entity?
   :engagement/requires-nib? :engagement/nib-verified?
...
(defn- pull->engagement [m]
  (when (:engagement/id m)
    {:id (:engagement/id m) :operator (:engagement/operator m) :portal (:engagement/portal m)
     ...
     :requires-id-entity? (boolean (:engagement/requires-id-entity? m))
     :has-id-entity? (boolean (:engagement/has-id-entity? m))
     :requires-nib? (boolean (:engagement/requires-nib? m))
     :nib-verified? (boolean (:engagement/nib-verified? m))
