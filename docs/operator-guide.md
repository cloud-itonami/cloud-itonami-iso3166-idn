...
2. Register the client's intake: business type, target public function,
   prior filing history in Indonesia if any.
3. Run the advisor in read-only mode against SPSE (Sistem Pengadaan Secara Elektronik), Indonesia's electronic procurement system overseen by LKPP (Lembaga Kebijakan Pengadaan Barang/Jasa Pemerintah).
...
- named referral relationship with Indonesian-licensed counsel or a
...
a working referral relationship with Indonesian-licensed counsel or a
registered agent for whatever licensed representation the law of
Indonesia requires for actual public-procurement filings.
